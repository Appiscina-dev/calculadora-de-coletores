...
async function sendContactToTelegram(name, phone) {
    ...
    const contactBotToken = 'token';
    const contactChatId = 'id';
...
document.getElementById('calculatorForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        const calculationBotToken = 'token2';
        const calculationChatId = 'id2';
...
whatsappForm.addEventListener('submit', async function(e) {
    ...
    window.open(`https://wa.me/554398590169?text=${encodeURIComponent(whatsappMsg)}`, '_blank');
...
logoLink.addEventListener('click', function(e) {
    e.preventDefault();
    window.open('https://appiscina.com.br/', '_blank'); // Abre em nova aba
});
